...
package org.apache.flink.streaming.examples.errordetection;
...
import org.apache.flink.streaming.examples.errordetection.util.ErrorDetectionData;
...
/**
 * Implements the "ErrorDetection" program that computes a simple word occurrence
 * histogram over text files in a streaming fashion.
 *
 * <p>The input is a plain text file with lines separated by newline characters.
 *
 * <p>Usage: <code>ErrorDetection --input &lt;path&gt; --output &lt;path&gt;</code><br>
 * 	./build-target/bin/flink run ./flink-examples/flink-examples-streaming/target/ErrorDetection.jar
 * 		--window 1
 * 		--slide 1
 * 		--output test.txt
...
public class ErrorDetection {
	...
	public static void main(String[] args) throws Exception {
		...
		if (params.has("input")) {
			...
			text = env.fromElements(ErrorDetectionData.ERROR_LOGS);
		}
